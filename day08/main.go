...
func part1() {
	...
	for _, line := range lines {
		...
		ss := strings.Split(ps[0], " ")
		os := strings.Split(ps[1], " ")
		_ = os
...
const input = `aedcg db ecbdgf badfegc abfcde edb cbgfe bfdg bdgec agfbce | ecagd gcbde dbcefa bgfd
